...
export const routes: RouteObject[] = [
    ...
    {
        path: PATTERN_ROUTE.HASHTAG,
        element: <TagVideoPage />
    },
    {
        path: ROUTE.STUDIO_UPLOAD,
        element: <UploadPage />
    },
    {
        path: ROUTE.STUDIO_POST_WRITE,
    ...
    {
        path: PATTERN_ROUTE.PROFILE_SWIPE_VIDEO,
        element: <SwipeVideoPage />
    },
    {
        path: ROUTE.VIDEO_EDIT,
        element: <EditPage />
    },
    {
        path: PATTERN_ROUTE.PROFILE,
        element: <ProfilePage />
    },
    {
        path: PATTERN_ROUTE.PROFILE_POST_DETAIL,
        element: <ProfilePostDetailPage />
    },
    {
    ...
    {
        path: PATTERN_ROUTE.WILD_CARD,
        element: <NotFoundWhat />
    }
];